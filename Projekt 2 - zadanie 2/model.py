...
class CNN(nn.Module):
    def __init__(self, in_side_len: int, in_channels: int, cnv0_out_channels: int,
                 cnv1_out_channels: int, lin0_out_size: int, lin1_out_size: int,
                 convolution_kernel: int, pooling_kernel: int):  # , lin2_out_size: int = 0):
        ...
        # self.lin2_out_size: int = lin2_out_size
        ...
        # self.lin2 = nn.Linear(self.lin1_out_size, self.lin2_out_size)
