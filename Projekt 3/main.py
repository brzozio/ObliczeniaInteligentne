...
#data_MLP_mnist_conv     = datasets_get.mnist_extr_conv(device, True, True)
#data_MLP_mnist_diff     = datasets_get.mnist_extr_diff(device, True, True)
...
def loading_state_dict():
    model_CNN_mnist.load_state_dict(torch.load('./models/CNN_mnist.pth'))
    model_CNN_cifar.load_state_dict(torch.load('./models/CNN_cifar.pth'))
    model_MLP_iris.load_state_dict(torch.load('./models/MLP_iris.pth'))
    model_MLP_wine.load_state_dict(torch.load('./models/MLP_wine.pth'))
    model_MLP_breast_cancer.load_state_dict(torch.load('./models/MLP_breast_cancer.pth'))
    model_MLP_mnist_conv.load_state_dict(torch.load('./models/MLP_mnist_extr_conv.pth'))
    model_MLP_mnist_diff.load_state_dict(torch.load('./models/MLP_mnist_extr_diff.pth'))
