...
#Granice decyzyjne
        ...
        print(f'KNN train-set MIN (CSV: 2_{index+2}) Confusion matrix: {confusion_matrix(Data_train[:, 2],knn_classifier_granica_TRAIN_WORST.predict(Data_train[:, 0:2]))}')
        ...
        print(f'KNN test-set MIN (CSV: 2_{index+2}) Confusion matrix: {confusion_matrix(Data_train[:, 2],knn_classifier_granica_TEST_WORST.predict(Data_train[:, 0:2]))}')
...
#Granice decyzyjne
        ...
        svc_classifier_granica_TRAIN_WORST = SVC(kernel='linear', C=c_parameter_SVM[0])
        ...
        print(f'SVM train-set MIN (CSV: 2_{index+2}) Confusion matrix: {confusion_matrix(Data_train[:, 2],svc_classifier_granica_TRAIN_WORST.predict(Data_train[:, 0:2]))}')
        ...
        svc_classifier_granica_TEST_WORST = SVC(kernel='linear', C=c_parameter_SVM[0])
        ...
        print(f'SVM test-set MIN (CSV: 2_{index+2}) Confusion matrix: {confusion_matrix(Data_train[:, 2],svc_classifier_granica_TEST_WORST.predict(Data_train[:, 0:2]))}')
...
#Granice decyzyjne
        ...
        svm_ax[1, 0].set_title(f"MLP train-set MIN (CSV: 2_{index+2}) (hidden_layers={worst_acc_c_train})")
        print(f'MLP train-set MIN (CSV: 2_{index+2}) Confusion matrix: {confusion_matrix(Data_train[:, 2],mlp_classifier_TRAIN_WORST.predict(Data_train[:, 0:2]))}')
        ...
        svm_ax[1, 1].set_title(f"MLP test-set MIN (CSV: 2_{index+2}) (hidden_layers={worst_acc_c_test})")
        print(f'MLP test-set MIN (CSV: 2_{index+2}) Confusion matrix: {confusion_matrix(Data_train[:, 2],mlp_classifier_TEST_WORST.predict(Data_train[:, 0:2]))}')
