...
#Granice decyzyjne
        ...
        knn_ax[1, 0].set_title(f"KNN train-set MIN (CSV: 2_{index+2}) (Neighbours={knn_n_neighbours[0]})")
        print(f'KNN train-set MIN (CSV: 2_{index+2}) Confusion matrix: {confusion_matrix(y_train,knn_classifier_granica_WORST.predict(X_train))}')
        ...
        knn_ax[1, 1].set_title(f"KNN test-set MIN (CSV: 2_{index+2}) (Neighbours={knn_n_neighbours[0]})")
        print(f'KNN test-set MIN (CSV: 2_{index+2}) Confusion matrix: {confusion_matrix(y_test,knn_classifier_granica_WORST.predict(X_test))}')
...
#Granice decyzyjne
        ...
        print(f'SVM train-set MIN (CSV: 2_{index+2}) Confusion matrix: {confusion_matrix(y_train,svc_classifier_granica_WORST.predict(X_train))}')
        ...
        print(f'SVM test-set MIN (CSV: 2_{index+2}) Confusion matrix: {confusion_matrix(y_test,svc_classifier_granica_WORST.predict(X_test))}')
...
#Granice decyzyjne
        ...
        print(f'MLP train-set MIN (CSV: 2_{index+2}) Confusion matrix: {confusion_matrix(y_train,mlp_classifier_WORST.predict(X_train))}')
        ...
        print(f'MLP test-set MIN (CSV: 2_{index+2}) Confusion matrix: {confusion_matrix(y_test,mlp_classifier_WORST.predict(X_test))}')
